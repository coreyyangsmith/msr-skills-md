"""
Tests for B_generate_dataset.py
"""
...
from B_generate_dataset import (
    RepoDatasetRow,
    SkillInstance,
    SkillMetrics,
...
class TestBGenerateDataset(unittest.TestCase):
    ...
    @mock.patch("B_generate_dataset.fetch_repo_tree")
    @mock.patch("B_generate_dataset.download_skill_files", return_value=[])
    ...
    @mock.patch("B_generate_dataset.download_blob")
    def test_download_skill_files(self, mock_download):
        ...
        from B_generate_dataset import download_skill_files
