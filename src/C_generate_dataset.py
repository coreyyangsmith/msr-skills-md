#!/usr/bin/env python3
"""
C_generate_dataset.py

Re-processes repositories from B_extract_skill_repos.py output to:
...
# All columns present in a SEART CSV export (mirrors B_extract_skill_repos.py).
