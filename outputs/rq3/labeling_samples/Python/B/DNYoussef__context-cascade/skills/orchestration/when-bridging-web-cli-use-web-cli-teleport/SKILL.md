/*============================================================================*/
/* WHEN-BRIDGING-WEB-CLI-USE-WEB-CLI-TELEPORT SKILL :: VERILINGUA x VERIX EDITION                      */
/*============================================================================*/
...
version: 1.0.0
description: |
  [assert|neutral] Bridge web interfaces with CLI workflows for seamless bidirectional integration [ground:given] [conf:0.95] [state:confirmed]
category: workflow
tags:
- web
- cli
...
cognitive_frame:
  primary: aspectual
  goal_analysis:
    first_order: "Execute when-bridging-web-cli-use-web-cli-teleport workflow"
