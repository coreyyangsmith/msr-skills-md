---
name: maestro:springboot-patterns
description: "Spring Boot architecture patterns, REST API design, layered services, and caching. Use during maestro:implement when building Java Spring Boot backend services."
lifecycle: [implement]
domain: [framework:springboot]
---
...
### Phase Guidance
**In maestro:implement**: Apply Spring Boot patterns during service implementation. Use layered architecture, proper exception handling, and Spring conventions.
