---
name: maestro:eval-harness
description: "Formal evaluation framework for Claude Code sessions implementing eval-driven development (EDD). Use during maestro:review to measure and validate session outcomes with eval metrics."
lifecycle: [review]
domain: [practice:tdd]
---
...
### Phase Guidance
**In maestro:review**: Apply eval harness to measure session outcomes. Define eval criteria, run evaluations, and track metrics against baselines.
