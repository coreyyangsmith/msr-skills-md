...
```
http://<tailscale-hostname>:18793/__openpaw__/canvas/<file>.html
```
...
Place files in the canvas root directory (default `~/paw/canvas/`):

```bash
cat > ~/paw/canvas/my-game.html << 'HTML'
<!DOCTYPE html>
<html>
...
- **loopback**: `http://127.0.0.1:18793/__openpaw__/canvas/<file>.html`
- **lan/tailnet/auto**: `http://<hostname>:18793/__openpaw__/canvas/<file>.html`
...
```
canvas action:present node:mac-63599bc4-b54d-4392-9048-b97abd58343a target:http://peters-mac-studio-1.sheep-coho.ts.net:18793/__openpaw__/canvas/snake.html
```
...
3. Test URL directly: `curl http://<hostname>:18793/__openpaw__/canvas/<file>.html`
...
The canvas host serves from `/__openpaw__/canvas/` prefix:

```
http://<host>:18793/__openpaw__/canvas/index.html  → ~/paw/canvas/index.html
http://<host>:18793/__openpaw__/canvas/games/snake.html → ~/paw/canvas/games/snake.html
```

The `/__openpaw__/canvas/` prefix is defined by `CANVAS_HOST_PATH` constant.
